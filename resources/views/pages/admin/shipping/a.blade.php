    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body wizard-content">
               <form action="{{ isset($shipping) ? route('admin.shipping.update', $shipping->id) : route('admin.shipping.store')}}" enctype="multipart/form-data" class="validation-wizard wizard-circle" method="POST">
                    <!-- Step 1 -->
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="card">
                                            <div class="el-card-item">
                                                <div class="el-card-avatar el-overlay-1"> <img src="{{ asset('storage/files/Image/'.$shipping->tax_proof) }}" alt="user" />
